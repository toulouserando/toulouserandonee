...
// 📦 1. On isole tout le formulaire actuel dans un sous-composant interne
function CreateEventFormRando10() {
  const router = useRouter();
  const searchParams = useSearchParams();
  
  const id = searchParams.get('id');
  const sourceParam = searchParams.get('source') || 'rando_Haute_Garonne'; 
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8 bg-slate-50/40 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-6 bg-slate-900 p-8 rounded-2xl shadow-xl mt-10">
        ...
        <div className="flex flex-wrap gap-4 w-full md:w-auto justify-center">
          ...
          {/* ✅ handleCreateEvent remplacé par handleSave */}
...
// 👑 2. L'export par défaut qui enveloppe tout dans le Suspense Boundary requis
