...
function CreateEventFormRando6() {
  ...
  // Récupération des paramètres de l'URL (?source=rando_Lot_en_Velo&id=filename_du_circuit)
  const id = searchParams.get('id');
  const sourceParam = searchParams.get('source') || 'rando_Lot_en_Velo'; 
