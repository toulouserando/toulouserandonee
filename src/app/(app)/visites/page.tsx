...
export default function VisitesPage() {
  ...
  if (!selectedVille) {
    return <div className="p-10 text-center text-slate-500">Aucun guide de visite valide trouvé.</div>;
  }
      ...
      <header className="bg-slate-900 text-white sticky top-0 z-40 shadow-md">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-black tracking-wider uppercase text-xs text-slate-400 hidden sm:inline">Explorateur Urbain</span>
          </div>
      ...
      <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            {selectedVille.points.length} points d'intérêt répertoriés sur ce parcours.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {/* CORRECTION : Ajout de 'idx' dans la boucle pour concevoir une key infalsifiable */}
